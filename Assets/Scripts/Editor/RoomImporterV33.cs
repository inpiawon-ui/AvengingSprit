...
namespace Game.EditorTools
{
    ...
    public static class RoomImporterV33
    {
        ...
        ///
        /// ⚠ 게임의 걷는 한계(`BattleDirector.RoomEdgeMeters`)는 2026-09-11 에 24 px 로 줄었다(벽 띠를
        ///   얇게 다시 받음). 이 값은 **배치 여백**이라 1 m 그대로 둔다 — 줄이면 다시 임포트할 때
        ///   지형·적 자리가 전부 움직인다. 걷는 자리가 넓어질 뿐이라 막히는 길은 생기지 않는다.
        /// </summary>
