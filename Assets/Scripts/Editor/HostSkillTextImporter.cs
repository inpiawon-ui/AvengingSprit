...
namespace Game.EditorTools
{
    ...
    public static class HostSkillTextImporter
    {
        ...
        {
            new[]{ "amazon",           "도약 강타",     "가장 가까운 적에게 뛰어들어 둘레를 300% 피해로 친다." },
            new[]{ "amazon_elite",     "불굴",          "무적 2.5초 + 쉴드 상한 해제. 해제가 무적보다 1.5초 더 간다." },
            new[]{ "baseball",         "전탄 반사",     "4초간 날아오는 탄을 되받아친다. 반사탄은 더 아프다." },
            new[]{ "death",            "사신의 시간",   "3초간 때리는 적이 죽는다. 중간 보스는 절반, 보스는 열에 하나." },
            new[]{ "guru",             "수호 결계",     "3초간 받는 피해 −50% · 쉴드 획득 2배." },
            ...
            new[]{ "hopper_smg",       "도약 강습",     "가장 먼 적에게 뛰어들고 2초간 무적." },
            new[]{ "ninja",            "그림자 분신",   "방 한가운데 분신을 세운다. 5초간 적이 전부 분신을 노린다." },
            new[]{ "vampire",          "혈연",          "둘레 5 m 의 적 머릿수만큼 최대 체력의 2% 씩 회복한다." },
            new[]{ "commando_mg",      "방벽 전개",     "5초간 최대 체력만큼 쉴드를 두른다. 깎이면 끝난다." },
            new[]{ "gangster",         "일제 표식",     "방 안 모든 적에게 3초간 표식을 새긴다." },
            new[]{ "hopper",           "정조준",        "5초간 치명타 확률이 90% 로 고정된다." },
            new[]{ "commando_missile", "다중 유도",     "반원으로 퍼진 8발이 한 대상으로 모여 든다." },
            new[]{ "medium",           "골렘 소환",     "골렘을 세운다. 해골보다 크고 오래 싸운다." },
            new[]{ "white_wizard",     "광휘 확산",     "부채꼴 8방향으로 광탄을 쏜다." },
            new[]{ "commando_laser",   "연쇄 방전",     "3초간 주변 적에게 전기가 계속 튄다." },
            new[]{ "robot",            "포탑 전개",     "10초간 자동으로 쏘는 포탑을 세운다." },
        };
