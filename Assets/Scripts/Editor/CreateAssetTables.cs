...
namespace Game.Editor
{
    ...
    public static class CreateAssetTables
    {
        ...
        private static readonly object[][] Buffs =
        {
            ...
            new object[]{ "fire_firmware", "화염 펌웨어", "로봇 설치물이 화염·과열을 물려받는다", BuffKind.DeployFire, 1, false, "#F07828", "BUF_S01", "Robot deployables inherit Fire and Overheat", "Synergy", 2, 1.0f, true },
            new object[]{ "arcane_execution", "비전 처형", "화이트위저드→닌자: 빙결 대상도 처형 연쇄", BuffKind.SynergyGate, 0, false, "#A886FF", "BUF_S02", "Frozen/Marked target blink detonation chains", "Synergy", 2, 1.0f, true },
            new object[]{ "crimson_combo", "핏빛 연격", "흡혈귀→아마존: 근접 마무리마다 회복", BuffKind.SynergyGate, 0, false, "#E04A7A", "BUF_S03", "Leech marks heal on each combo finisher", "Synergy", 2, 0.9f, true },
            ...
            new object[]{ "curse_inferno", "저주 화염", "영매→드라군: 저주 걸린 적이 죽으면 불기둥", BuffKind.SynergyGate, 0, false, "#F07828", "BUF_S05", "Curse circuit becomes napalm pillars", "Synergy", 3, 0.9f, true },
            new object[]{ "guarded_rush", "수호 돌진", "구루→아마존: 대시 중 받는 피해 절반", BuffKind.SynergyGate, 0, false, "#5CC850", "BUF_S06", "consume Guard aura for armored dash", "Synergy", 2, 0.8f, true },
