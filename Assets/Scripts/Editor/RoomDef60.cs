        ...
        public static readonly Room[] All =
        {
            new() { Ch = 1, No = "001", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 1.5f, Y = 6.5f, Role = "FLANK", Unit = "scrapgunner", IsHost = false },
            ...
            new() { Ch = 1, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2f, Y = 7.5f, Role = "FLANK", Unit = "scrapgunner", IsHost = false },
                        new() { X = 8f, Y = 7.5f, Role = "FLANK", Unit = "scrapgunner", IsHost = false },
                        new() { X = 8f, Y = 10f, Role = "FLANK", Unit = "scrapgunner", IsHost = false },
            ...
            new() { Ch = 1, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2f, Y = 4.5f, Role = "FRONT", Unit = "scrapgunner", IsHost = false },
                        new() { X = 8.5f, Y = 8f, Role = "RANGED", Unit = "scrapgunner", IsHost = false },
                        new() { X = 5f, Y = 3.5f, Role = "FRONT", Unit = "scrapgunner", IsHost = false },
                    },
                    },
            new() { Ch = 1, No = "004", Kind = "이벤트",
                    Floor = "roomfloor_env_junkyard", Layout = "", LayoutKo = "",
                    Comp = "", Pool = "몸", Boss = "", Captain = "",
                    Minions = 0, Elite = false,
                    },
            ...
            new() { Ch = 1, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 6.5f, Y = 10f, Role = "FLANK", Unit = "scrapgunner", IsHost = false },
                        new() { X = 7f, Y = 7.5f, Role = "RANGED", Unit = "scrapgunner", IsHost = false },
            ...
            new() { Ch = 1, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 7.5f, Y = 5.5f, Role = "FLANK", Unit = "scrapgunner", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "scrapgunner", IsHost = false },
                        new() { X = 5f, Y = 2.5f, Role = "FRONT", Unit = "scrapgunner", IsHost = false },
                    },
                    },
            new() { Ch = 1, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2.5f, Y = 2.5f, Role = "FRONT", Unit = "scrapgunner", IsHost = false },
                        new() { X = 7.5f, Y = 7.5f, Role = "RANGED", Unit = "scrapgunner", IsHost = false },
                        new() { X = 5f, Y = 1.5f, Role = "FRONT", Unit = "scrapgunner", IsHost = false },
            ...
            new() { Ch = 2, No = "001", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 8f, Y = 7.5f, Role = "FLANK", Unit = "roadwarden", IsHost = false },
                        new() { X = 8f, Y = 10f, Role = "FLANK", Unit = "roadwarden", IsHost = false },
            ...
            new() { Ch = 2, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2f, Y = 4.5f, Role = "FRONT", Unit = "roadwarden", IsHost = false },
                        new() { X = 8.5f, Y = 8f, Role = "RANGED", Unit = "roadwarden", IsHost = false },
                        new() { X = 5f, Y = 3.5f, Role = "FRONT", Unit = "roadwarden", IsHost = false },
                    },
                    },
            new() { Ch = 2, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 8f, Y = 5.5f, Role = "FLANK", Unit = "commando_mg", IsHost = true },
                        new() { X = 3f, Y = 7.5f, Role = "RANGED", Unit = "roadwarden", IsHost = false },
                        new() { X = 6.5f, Y = 10f, Role = "FLANK", Unit = "roadwarden", IsHost = false },
            ...
            new() { Ch = 2, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 7.5f, Y = 5.5f, Role = "FLANK", Unit = "roadwarden", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "roadwarden", IsHost = false },
                        new() { X = 5f, Y = 2.5f, Role = "FRONT", Unit = "roadwarden", IsHost = false },
                    },
                    },
            ...
            new() { Ch = 2, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2.5f, Y = 2.5f, Role = "FRONT", Unit = "roadwarden", IsHost = false },
                        new() { X = 7.5f, Y = 7.5f, Role = "RANGED", Unit = "roadwarden", IsHost = false },
                        new() { X = 5f, Y = 1.5f, Role = "FRONT", Unit = "roadwarden", IsHost = false },
            ...
            new() { Ch = 2, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 8f, Y = 7f, Role = "RANGED", Unit = "roadwarden", IsHost = false },
                        new() { X = 6.5f, Y = 2f, Role = "FLANK", Unit = "roadwarden", IsHost = false },
                        new() { X = 5f, Y = 3f, Role = "RANGED", Unit = "roadwarden", IsHost = false },
                        new() { X = 8.5f, Y = 1.5f, Role = "FLANK", Unit = "roadwarden", IsHost = false },
                        new() { X = 6.5f, Y = 10f, Role = "BACK", Unit = "roadwarden", IsHost = false },
                        new() { X = 5.5f, Y = 7.5f, Role = "FRONT", Unit = "roadwarden", IsHost = false },
                    },
                    },
            ...
            new() { Ch = 3, No = "001", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 3.5f, Y = 8.5f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 2f, Y = 4.5f, Role = "FRONT", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 8.5f, Y = 8f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 3, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 8f, Y = 5.5f, Role = "FLANK", Unit = "amazon", IsHost = true },
                        new() { X = 3f, Y = 7.5f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 6.5f, Y = 10f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 7f, Y = 7.5f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 8f, Y = 9.5f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 5f, Y = 9.5f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
                    },
                    },
            new() { Ch = 3, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 3, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 7.5f, Y = 7.5f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 5f, Y = 1.5f, Role = "FRONT", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 7.5f, Y = 10f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 5f, Y = 9.5f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
                    },
                    },
            ...
            new() { Ch = 3, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 3f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 8.5f, Y = 1.5f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 6.5f, Y = 10f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 3, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 1.5f, Y = 5.5f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 2.5f, Y = 9.5f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 7.5f, Y = 9.5f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 4, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 8.5f, Role = "RANGED", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 5, No = "001", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 5, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2.5f, Y = 2.5f, Role = "FRONT", Unit = "skeleton", IsHost = false },
                        new() { X = 7.5f, Y = 7.5f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                        new() { X = 5f, Y = 1.5f, Role = "FRONT", Unit = "skeleton", IsHost = false },
                        new() { X = 7.5f, Y = 10f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                        new() { X = 5f, Y = 9.5f, Role = "BACK", Unit = "skeleton", IsHost = false },
                    },
                    },
            new() { Ch = 5, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 3f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                        new() { X = 8.5f, Y = 1.5f, Role = "FLANK", Unit = "skeleton", IsHost = false },
                        new() { X = 6.5f, Y = 10f, Role = "BACK", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 5, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2.5f, Y = 9.5f, Role = "BACK", Unit = "skeleton", IsHost = false },
                        new() { X = 7.5f, Y = 9.5f, Role = "BACK", Unit = "skeleton", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 5, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 8.5f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 5, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 6.5f, Y = 7.5f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                        new() { X = 3.5f, Y = 10f, Role = "BACK", Unit = "skeleton", IsHost = false },
                        new() { X = 6.5f, Y = 10f, Role = "BACK", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 6, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 3f, Y = 5.5f, Role = "FRONT", Unit = "skeleton", IsHost = false },
                        new() { X = 7f, Y = 5.5f, Role = "FRONT", Unit = "skeleton", IsHost = false },
                        new() { X = 5f, Y = 6.5f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                    },
                    },
            ...
            new() { Ch = 6, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2f, Y = 7.5f, Role = "FLANK", Unit = "skeleton", IsHost = false },
                        new() { X = 3.5f, Y = 8f, Role = "BACK", Unit = "skeleton", IsHost = false },
                        new() { X = 8f, Y = 7.5f, Role = "FLANK", Unit = "skeleton", IsHost = false },
                        new() { X = 6.5f, Y = 8f, Role = "FLANK", Unit = "skeleton", IsHost = false },
                        new() { X = 2f, Y = 5f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                        new() { X = 8f, Y = 5f, Role = "RANGED", Unit = "skeleton", IsHost = false },
                        new() { X = 3.5f, Y = 3.5f, Role = "FRONT", Unit = "skeleton", IsHost = false },
                    },
                    },
