    ...
    public static class RoomDef60
    {
        ...
        public static readonly Room[] All =
        {
            new() { Ch = 1, No = "001", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 7.5f, Y = 3.5f, Role = "FLANK", Unit = "amazon", IsHost = true },
            ...
            new() { Ch = 1, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "commando_grenade", IsHost = true },
            ...
            new() { Ch = 1, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 3f, Y = 6.5f, Role = "FRONT", Unit = "baseball", IsHost = true },
            ...
            new() { Ch = 1, No = "005", Kind = "중간보스",
                    ...
                    Comp = "", Pool = "", Boss = "", Captain = "baseball",
                    Minions = 3, Elite = false,
                    MinionFrom = new[] { "amazon", "commando_mg", "commando_grenade" },
                    },
            ...
            new() { Ch = 1, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 2.5f, Y = 9.5f, Role = "BACK", Unit = "commando_grenade", IsHost = true },
            ...
            new() { Ch = 1, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 3f, Role = "FRONT", Unit = "baseball", IsHost = true },
            ...
            new() { Ch = 2, No = "001", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "dragon_blue", IsHost = true },
                        new() { X = 2f, Y = 7.5f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 2, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 3f, Y = 6.5f, Role = "FRONT", Unit = "amazon", IsHost = true },
            ...
            new() { Ch = 2, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 3f, Y = 7.5f, Role = "RANGED", Unit = "hopper", IsHost = true },
                        new() { X = 6.5f, Y = 10f, Role = "FLANK", Unit = "bat", IsHost = false },
            ...
            new() { Ch = 2, No = "005", Kind = "중간보스",
                    Floor = "roomfloor_env_holding", Layout = "F", LayoutKo = "모서리 요새",
                    Comp = "", Pool = "", Boss = "", Captain = "commando_missile",
                    Minions = 3, Elite = false,
                    MinionFrom = new[] { "amazon", "baseball", "commando_mg", "commando_grenade", "hopper", "medium", "dragon_blue" },
                    },
            new() { Ch = 2, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 2.5f, Y = 9.5f, Role = "BACK", Unit = "commando_missile", IsHost = true },
                        new() { X = 2.5f, Y = 5.5f, Role = "FLANK", Unit = "baseball", IsHost = true },
            ...
            new() { Ch = 2, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 2.5f, Y = 7.5f, Role = "RANGED", Unit = "medium", IsHost = true },
            ...
            new() { Ch = 2, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 2f, Y = 7f, Role = "FLANK", Unit = "baseball", IsHost = true },
            ...
            new() { Ch = 3, No = "001", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 3f, Y = 6.5f, Role = "FRONT", Unit = "ninja_chain", IsHost = true },
            ...
            new() { Ch = 3, No = "002", Kind = "전투",
                    ...
                    {
                        new() { X = 8f, Y = 5.5f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 3f, Y = 7.5f, Role = "RANGED", Unit = "snowwoman", IsHost = true },
            ...
            new() { Ch = 3, No = "005", Kind = "중간보스",
                    Floor = "roomfloor_env_holding", Layout = "F", LayoutKo = "모서리 요새",
                    Comp = "", Pool = "", Boss = "", Captain = "ninja_chain",
                    Minions = 3, Elite = false,
                    MinionFrom = new[] { "amazon", "baseball", "commando_mg", "commando_grenade", "hopper", "commando_missile", "medium", "dragon_blue", "ninja", "snowwoman", "white_wizard" },
                    },
            new() { Ch = 3, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 3f, Role = "FRONT", Unit = "ninja_chain", IsHost = true },
                        new() { X = 2.5f, Y = 7.5f, Role = "RANGED", Unit = "ninja", IsHost = true },
                        new() { X = 2.5f, Y = 2.5f, Role = "FRONT", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 3, No = "008", Kind = "전투",
                    ...
                    {
                        new() { X = 2f, Y = 7f, Role = "FLANK", Unit = "baseball", IsHost = true },
                        new() { X = 8f, Y = 7f, Role = "RANGED", Unit = "white_wizard", IsHost = true },
                        new() { X = 6.5f, Y = 2f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 3, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 8.5f, Role = "BACK", Unit = "commando_mg", IsHost = true },
                        new() { X = 1.5f, Y = 5.5f, Role = "FLANK", Unit = "amazon", IsHost = true },
                        new() { X = 2.5f, Y = 9.5f, Role = "BACK", Unit = "turret_cross", IsHost = false },
                        new() { X = 7.5f, Y = 9.5f, Role = "BACK", Unit = "coilwalker", IsHost = false },
            ...
            new() { Ch = 4, No = "001", Kind = "전투",
                    ...
                    {
                        new() { X = 8f, Y = 5.5f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 3f, Y = 7.5f, Role = "RANGED", Unit = "dragoon", IsHost = true },
                        new() { X = 6.5f, Y = 10f, Role = "FLANK", Unit = "bat", IsHost = false },
                        new() { X = 7f, Y = 7.5f, Role = "RANGED", Unit = "coilwalker", IsHost = false },
                        new() { X = 8f, Y = 9.5f, Role = "BACK", Unit = "roadwarden", IsHost = false },
                        new() { X = 5f, Y = 9.5f, Role = "BACK", Unit = "coilwalker", IsHost = false },
            ...
            new() { Ch = 4, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 3f, Role = "FRONT", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 4, No = "005", Kind = "중간보스",
                    Floor = "roomfloor_env_holding", Layout = "F", LayoutKo = "모서리 요새",
                    Comp = "", Pool = "", Boss = "", Captain = "gangster",
                    Minions = 3, Elite = false,
                    MinionFrom = new[] { "amazon", "baseball", "commando_mg", "commando_grenade", "hopper", "commando_missile", "medium", "dragon_blue", "ninja_chain", "ninja", "snowwoman", "white_wizard", "thug", "guru", "dragoon" },
                    },
            new() { Ch = 4, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 2f, Y = 7f, Role = "FLANK", Unit = "gangster", IsHost = true },
                        new() { X = 8f, Y = 7f, Role = "RANGED", Unit = "dragon_blue", IsHost = true },
                        new() { X = 6.5f, Y = 2f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 5f, Y = 3f, Role = "RANGED", Unit = "roadwarden", IsHost = false },
            ...
            new() { Ch = 4, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 8.5f, Role = "BACK", Unit = "hopper", IsHost = true },
            ...
            new() { Ch = 4, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 3f, Y = 3f, Role = "FRONT", Unit = "baseball", IsHost = true },
                        new() { X = 5f, Y = 6f, Role = "RANGED", Unit = "commando_missile", IsHost = true },
            ...
            new() { Ch = 5, No = "001", Kind = "전투",
                    ...
                    {
                        new() { X = 2.5f, Y = 9.5f, Role = "BACK", Unit = "turret_cross", IsHost = false },
                        new() { X = 2.5f, Y = 5.5f, Role = "FLANK", Unit = "amazon_elite", IsHost = true },
                        new() { X = 7.5f, Y = 9.5f, Role = "BACK", Unit = "coilwalker", IsHost = false },
                        new() { X = 7.5f, Y = 5.5f, Role = "FLANK", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "turret_cross", IsHost = false },
                        new() { X = 5f, Y = 2.5f, Role = "FRONT", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 5, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 3f, Role = "FRONT", Unit = "skeleton", IsHost = false },
                        new() { X = 2.5f, Y = 7.5f, Role = "RANGED", Unit = "hopper_smg", IsHost = true },
                        new() { X = 2.5f, Y = 2.5f, Role = "FRONT", Unit = "actor_enforcer", IsHost = false },
            ...
            new() { Ch = 5, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 8f, Y = 7f, Role = "RANGED", Unit = "turret_cross", IsHost = false },
            ...
            new() { Ch = 5, No = "005", Kind = "중간보스",
                    ...
                    Minions = 3, Elite = false,
                    MinionFrom = new[] { "amazon", "baseball", "commando_mg", "commando_grenade", "hopper", "commando_missile", "medium", "dragon_blue", "ninja_chain", "ninja", "snowwoman", "white_wizard", "gangster", "thug", "guru", "dragoon", "commando_laser", "amazon_elite", "hopper_smg" },
                    },
            new() { Ch = 5, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 8.5f, Role = "BACK", Unit = "robot", IsHost = true },
                        new() { X = 1.5f, Y = 5.5f, Role = "FLANK", Unit = "guru", IsHost = true },
                        new() { X = 2.5f, Y = 9.5f, Role = "BACK", Unit = "turret_cross", IsHost = false },
                        new() { X = 7.5f, Y = 9.5f, Role = "BACK", Unit = "coilwalker", IsHost = false },
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "turret_cross", IsHost = false },
            ...
            new() { Ch = 5, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 6f, Role = "RANGED", Unit = "commando_laser", IsHost = true },
            ...
            new() { Ch = 5, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 2f, Y = 6.5f, Role = "FLANK", Unit = "baseball", IsHost = true },
                        new() { X = 5f, Y = 8f, Role = "RANGED", Unit = "medium", IsHost = true },
            ...
            new() { Ch = 6, No = "001", Kind = "전투",
                    ...
                    {
                        new() { X = 5f, Y = 3f, Role = "FRONT", Unit = "skeleton", IsHost = false },
                        new() { X = 2.5f, Y = 7.5f, Role = "RANGED", Unit = "salamander", IsHost = true },
                        new() { X = 2.5f, Y = 2.5f, Role = "FRONT", Unit = "actor_enforcer", IsHost = false },
                        new() { X = 7.5f, Y = 7.5f, Role = "RANGED", Unit = "coilwalker", IsHost = false },
                        new() { X = 5f, Y = 1.5f, Role = "FRONT", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 6, No = "002", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 2f, Y = 7f, Role = "FLANK", Unit = "death", IsHost = true },
                        new() { X = 8f, Y = 7f, Role = "RANGED", Unit = "coilwalker", IsHost = false },
                        new() { X = 6.5f, Y = 2f, Role = "FLANK", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 6, No = "003", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 8.5f, Role = "BACK", Unit = "vampire", IsHost = true },
            ...
            new() { Ch = 6, No = "005", Kind = "중간보스",
                    ...
                    Minions = 3, Elite = false,
                    MinionFrom = new[] { "amazon", "baseball", "commando_mg", "commando_grenade", "hopper", "commando_missile", "medium", "dragon_blue", "ninja_chain", "ninja", "snowwoman", "white_wizard", "gangster", "thug", "guru", "dragoon", "robot", "commando_laser", "amazon_elite", "hopper_smg", "vampire", "death" },
                    },
            new() { Ch = 6, No = "006", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 3f, Y = 3f, Role = "FRONT", Unit = "salamander", IsHost = true },
                        new() { X = 5f, Y = 6f, Role = "RANGED", Unit = "commando_grenade", IsHost = true },
                        new() { X = 7f, Y = 3f, Role = "FRONT", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 6, No = "008", Kind = "전투",
                    ...
                    Spawns = new Spawn[]
                    {
                        ...
                        new() { X = 5f, Y = 8f, Role = "RANGED", Unit = "snowwoman", IsHost = true },
                        new() { X = 8f, Y = 6.5f, Role = "FLANK", Unit = "skeleton", IsHost = false },
            ...
            new() { Ch = 6, No = "009", Kind = "엘리트",
                    ...
                    Spawns = new Spawn[]
                    {
                        new() { X = 5f, Y = 10f, Role = "BACK", Unit = "ninja", IsHost = true },
                        new() { X = 2f, Y = 7.5f, Role = "FLANK", Unit = "amazon", IsHost = true },
