...
namespace Game.EditorTools
{
    ...
    public static class TestSwitches
    {
        ...
        //
        //   001 로봇스네이크 1650 · 002 크러셔 2400 · 003 파이썬 3150
        //   004 슬러지 4300      · 005 가디언 5200  · 006 킹핀 6900
        //
        // ⚠ 이것이 **원작 순서**다(사용자 원작 스샷 대조 2026-09-07). 킹핀이 최종 보스다.
        //   HP·공격력 수열은 **자리에 붙는다** — 보스 고유값이 아니라 무대 순서 값이다.
        //   여기 적힌 것이 `BossTable` 순서와 어긋나면 이 주석이 거짓말이 된다 — 표가 정본이다.
        //
        ...
        { "순서대로 (1~6방)", "1 로봇 스네이크", "2 크러셔", "3 파이썬", "4 슬러지", "5 가디언", "6 킹핀" };
