    ...
    public static class BossDefTable
    {
        ...
        public static readonly Boss[] All =
        {
            ...
            new() { Key = "guardian", NameKr = "가디언", NameEn = "Guardian", Sprite = "unit_guardian",
                    ...
                    //   거리를 좁히는 일은 **「마디 돌진」이 한다** — 줄을 긋고 그 줄을
                    //   타고 날아가 뚫는다. 다리로 걸어올 이유가 없다.
                    //   거리를 고르는 쪽은 플레이어이고, 고른 거리가 곧 어떤 패턴을
                    //   상대할지를 정한다.
                    State = "Segments", Chases = false, BreakSeconds = 0.0f, BreakCause = "마디를 3개 이하로 끊었다 — 머리 무적이 영구히 풀린다",
                    Moves = new Move[]
                    {
                        ...
                        // ⚠ 반경 3.5 → 1.75 → **2.625 m** (기획 2026-09-03, 두 번 고침).
                        //   근접 몸이 때리는 자리는 보스 중심에서 1.34 m 다. 3.5 m 원은
                        //   그 자리를 한참 삼켜서 물러날 곳이 없었고, 반으로 줄인 1.75 m 는
