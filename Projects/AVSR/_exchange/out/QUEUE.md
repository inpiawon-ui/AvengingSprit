...
| **32** | **`thug` 걷기** | — | 10 | 🔴 최우선 — 걷기만 다른 인물이다 |
| **33** | **프레임 일관성 수정 7종** | — | 약 20 | 같은 캐릭터 안에서 요소가 사라진다 |
| **34** | **얼티밋 `hopper` 재작업** | — | 1 | 어두워서 실루엣이 안 읽힌다 |
| **35** | **투사체 8종** | — | 8 | 21종이 노란 탄 하나를 같이 쓰고 있다 |

> **작업 순서: 32 → 33 → 34 → 35 → 30.**
