# 발주 — 인게임 UI 조각: 카드 틀 네 등급을 한 장에 나란히 (864 × 500)
...
| `Assets/BaseResource/Card/cardpanel_rare.png` | 지금 이 자리의 그림(교체 대상) — 크기 · 쓰임만 참고, 생김새는 따르지 마라 |

## 이 조각

- 무엇: **카드 틀 네 등급을 한 장에 나란히** — 216×500 칸 넷: ① COMMON ② RARE ③ EPIC ④ LEGENDARY. 시안의 COMMON · RARE 틀 그대로, 위 등급일수록 한눈에 더 귀해 보이게. **틀만** — 안의 그림 · 글자 · 등급 딱지는 게임이 얹는다
...
`Projects/AVSR/_exchange/in/uipiece_cardpanels.png`
