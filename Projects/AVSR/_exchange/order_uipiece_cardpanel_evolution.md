...
| `Assets/BaseResource/Card/cardpanel_evolution.png` | 지금 이 자리의 그림(교체 대상) — 크기 · 쓰임만 참고, 생김새는 따르지 마라 |

## 이 조각

- 무엇: **진화 카드 틀** — 카드가 진화할 때 뜨는 작은 카드. 위 카드 틀과 한 벌. 틀만
...
| 항목 | 값 |
|---|---|
| 파일 | `uipiece_cardpanel_evolution.png` |
| 크기 | **208 × 300 px 정확히** |
...
`Projects/AVSR/_exchange/in/uipiece_cardpanel_evolution.png`
