# 발주 — 인게임 UI 조각: 상단 HUD 전체 **뒤판 (720 × 230)
...
| `Assets/BaseResource/InGameMainUI/hudbackdrop.png` | 지금 이 자리의 그림(교체 대상) — 크기 · 쓰임만 참고, 생김새는 따르지 마라 |

## 이 조각

- 무엇: 상단 HUD 전체 **뒤판** — 화면 맨 위 720×230 띠. 판들 뒤에 깔린다. 아래 가장자리가 전투 화면과 만나는 경계
...
`Projects/AVSR/_exchange/in/uipiece_hudbackdrop.png`
