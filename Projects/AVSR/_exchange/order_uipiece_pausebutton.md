# 발주 — 인게임 UI 조각: 오른쪽 위 **일시정지 버튼 (60 × 60)
...
| `Assets/BaseResource/InGameMainUI/pausebutton.png` | 지금 이 자리의 그림(교체 대상) — 크기 · 쓰임만 참고, 생김새는 따르지 마라 |
...
`Projects/AVSR/_exchange/in/uipiece_pausebutton.png`
