# 발주 — 인게임 UI 조각: 조이스틱 **손잡이**(가운데 빨간 공) (46 × 46)
...
| `Assets/BaseResource/InGameMainUI/hud_dpad_knob.png` | 지금 이 자리의 그림(교체 대상) — 크기 · 쓰임만 참고, 생김새는 따르지 마라 |

## 이 조각

- 무엇: 조이스틱 **손잡이**(가운데 빨간 공) — 판 위에서 움직인다
...
`Projects/AVSR/_exchange/in/uipiece_hud_dpad_knob.png`
