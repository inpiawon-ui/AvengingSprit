# 발주 — 인게임 UI 조각: 오른쪽 아래 **액션 영역 틀 (224 × 150)
...
| `Assets/BaseResource/InGameMainUI/hud_action_frame.png` | 지금 이 자리의 그림(교체 대상) — 크기 · 쓰임만 참고, 생김새는 따르지 마라 |

## 이 조각

- 무엇: 오른쪽 아래 **액션 영역 틀** — ACTION 글자 아래, 버튼들이 놓이는 테두리
...
| 항목 | 값 |
|---|---|
| 파일 | `uipiece_hud_action_frame.png` |
| 크기 | **224 × 150 px 정확히** |
...
`Projects/AVSR/_exchange/in/uipiece_hud_action_frame.png`
