# 발주 — 인게임 UI 조각: LEVEL UP 제목 그림 (560 × 96)
...
| `Assets/BaseResource/Card/leveluptitle.png` | 지금 이 자리의 그림(교체 대상) — 크기 · 쓰임만 참고, 생김새는 따르지 마라 |

## 이 조각

- 무엇: **LEVEL UP 제목 그림** — 시안의 LEVEL UP 글자 + 유령 불꽃 장식. 이 그림만은 글자가 들어간다(LEVEL UP)
...
| 항목 | 값 |
|---|---|
| 파일 | `uipiece_leveluptitle.png` |
| 크기 | **560 × 96 px 정확히** |
| 형식 | PNG **투명 배경**(알파). 조각 바깥은 완전히 투명. 뒤에 전투 화면을 그려 넣지 마라 |
| 글자 | LEVEL UP 글자만 그림에 넣는다 |
...
`Projects/AVSR/_exchange/in/uipiece_leveluptitle.png`
